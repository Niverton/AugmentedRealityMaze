...
public void rendreJouable()
{
    for (int i = 0; i < h; i++)
    {
        int x = (int)(Random.value * w);
        int y = (int)(Random.value * h);
...
public Arrete GetPorte()
{
    ...
    do
    {
        tmp = voisin[(int)(Random.value * w) + (int)(Random.value * h) * w].GetArrete((int)(Random.value * 4));
