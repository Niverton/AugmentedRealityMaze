...
public class Point {
    ...
    public void changerMatiereArrete(int i, Arrete.Matiere type)
    {
    ...
    public Point GetSud()
    {
        if (voisin[3].getType() == Arrete.Matiere.mur || voisin[3].getPoint1() == null || voisin[3].getPoint2() == null)
        {
            return null;
        }
    ...
    {
        if (voisin[1].getType() == Arrete.Matiere.mur || voisin[1].getPoint1() == null || voisin[1].getPoint2() == null)
        {
            return null;
        }
    ...
    {
        if (voisin[0].getType() == Arrete.Matiere.mur || voisin[0].getPoint1() == null || voisin[0].getPoint2() == null)
        {
            return null;
        }
    ...
    public Point GetEst()
    {
        if (voisin[2].getType() == Arrete.Matiere.mur || voisin[2].getPoint1() == null || voisin[2].getPoint2() == null)
        {
            return null;
        }
    ...
    {
        return (float)(Mathf.Pow(p1.GetX() - p2.GetX(), 2) + Mathf.Pow(p1.GetY() - p2.GetY(), 2));
    }
    ...
    {
        int tmp = (int)(Random.value * 4);
        while (voisin[tmp].Voisin(this) == null || voisin[tmp].Voisin(this).estSeul())
        {
            tmp = (int)(Random.value * 4);
        }
        voisin[tmp].setType(Arrete.Matiere.corridor);
    }

    //Retourne si tout les voisins sont tous occupés..voisin = arete/Voisin=sommet
    public bool AucunVoisinDispo()
    {
        bool vrai = voisin[0].Voisin(this) == null || !voisin[0].Voisin(this).estSeul();
    ...
    {
        int tmp = (int)Mathf.Floor(Random.value * 4);
        while (voisin[tmp].Voisin(this) == null || !voisin[tmp].Voisin(this).estSeul())
        {
            tmp = (int)Mathf.Floor(Random.value * 4);
        }
        voisin[tmp].setType(Arrete.Matiere.corridor);
